 ...
 */
class MessageStatusSubscription extends base_1.Subscription {
    /**
     ...
     */
    constructor(webhook, criteria, status = 'ACTIVE') {
        super('MESSAGE_STATUS', webhook, criteria, status);
    }
}
exports.MessageStatusSubscription = MessageStatusSubscription;
